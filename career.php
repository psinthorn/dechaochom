...
$contact_short = str_replace("apos","'",$thismenu["tcareer_text"]);
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12" style="<?=$padding;?>">
				<h2 class="mg-sec-left-title" style="margin-bottom:0px;"><?=$thismenu["tcareers"];?></h2>
				<p style="padding-bottom:20px;"><?=$contact_short;?> <?=$thishotel["career_email"];?> or Apply Online Application form</p>


<div align="center">
	<div style="width:80%;" align="left"><h3>Application Form</h3></div>
	<div id="contact_form" style="width:80%;padding:20px;border:1px solid #ddd;" align="left">
